    ...
    tab(tab)
{
    ...
    QAction *copyScrapeAddrAction = new QAction(tr("Copy Scrape Address"), this);
    ...
    connect(copyScrapeAddrAction, SIGNAL(triggered()), this, SLOT(onCopyScrapeAction()));
...
void AddressBookPage::onCopyScrapeAction()
{
